...
//세션 class가 관리자일 때 승인 과정
    ...
    if (isset($_POST['art_num']) && isset($_POST['import'])) {
        ...
        $admission = mysqli_query($conn, 'update article set ok=1, import=' . $import . ' ,novel=1,code=710004
                                        where art_num=' . $art_num);
        echo '<script>alert("소설연재로 승인되었습니다."); location.href="../view/main.php"</script>';
    }
    else
